...
function Navbar({ setMobileMenuOpen }) {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      {
        className:
          'flex relative z-10 shrink-0 h-16 bg-white border-b border-gray-200 shadow-sm'
      },
      /* @__PURE__ */ React.createElement(
        'button',
        {
          type: 'button',
          className:
            'px-4 text-gray-500 border-r border-gray-200 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 md:hidden',
          ...
          /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(
                ...
                {
                  className:
                    'flex absolute inset-y-0 left-0 items-center pointer-events-none'
                },
              ...
              /* @__PURE__ */ React.createElement('input', {
                ...
                id: 'search-field',
                className:
                  'py-2 pr-3 pl-8 w-full h-full text-base text-gray-900 placeholder:text-gray-500 focus:placeholder:text-gray-400 border-transparent focus:border-transparent focus:outline-none focus:ring-0',
                placeholder: 'Search',
                type: 'search'
              })
            )
          ...
          /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(
                ...
                {
                  className:
                    'flex text-sm bg-white rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
                },
                /* @__PURE__ */ React.createElement(
                  'span',
                  {
            ...
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(
                ...
                {
                  className:
                    'absolute right-0 py-1 mt-2 w-48 bg-white rounded-md focus:outline-none ring-1 ring-black/5 shadow-lg origin-top-right'
                },
                /* @__PURE__ */ React.createElement(
                  import_react3.Menu.Item,
                  null,
                  ({ active }) =>
                    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            ...
            {
              className:
                'flex relative flex-col flex-1 pt-5 pb-4 w-full max-w-xs bg-indigo-700'
            },
            /* @__PURE__ */ React.createElement(
              import_react6.Transition.Child,
              {
              ...
              /* @__PURE__ */ React.createElement(
                ...
                /* @__PURE__ */ React.createElement(
                  'button',
                  {
                    type: 'button',
                    className:
                      'flex justify-center items-center w-12 h-12 rounded-full focus:outline-none focus:ring-2 focus:ring-white',
...
function getTimeline({ createdById, id }) {
      ...
      /* @__PURE__ */ React2.createElement(
        ...
        /* @__PURE__ */ React2.createElement(
          ...
          /* @__PURE__ */ React2.createElement('input', {
            ...
            name: 'title',
            className:
              'flex-1 px-3 text-lg leading-loose rounded-md border-2 border-blue-500',
            'aria-invalid': (
      ...
      /* @__PURE__ */ React2.createElement(
        ...
        /* @__PURE__ */ React2.createElement(
          ...
          /* @__PURE__ */ React2.createElement('textarea', {
            ...
            ref: descriptionRef,
            className:
              'block w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm sm:text-sm',
      ...
      /* @__PURE__ */ React2.createElement(
        ...
        /* @__PURE__ */ React2.createElement(
          'button',
          {
            type: 'submit',
            className:
              'py-2 px-4 text-white bg-blue-500 hover:bg-blue-600 focus:bg-blue-400 rounded'
          },
          'Save'
        )
      )
      ...
      actions: /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          import_react11.Link,
          {
            to: '/timelines',
            className:
              'inline-flex items-center py-2 px-4 text-sm font-medium text-white bg-gray-600 hover:bg-gray-700 rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800 shadow-sm'
          },
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            'button',
            {
              type: 'submit',
              className:
                'inline-flex items-center py-2 px-4 ml-3 text-sm font-medium text-white bg-red-600 hover:bg-gray-700 rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-800 shadow-sm'
            },
        ...
        /* @__PURE__ */ React.createElement(
          import_react11.Link,
          {
            to: 'edit',
            className:
              'inline-flex items-center py-2 px-4 ml-3 text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-orange-800 shadow-sm'
          },
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          'select',
          {
            ...
            name: 'tabs',
            className:
              'block py-2 pr-10 pl-3 w-full text-base rounded-md border-gray-300 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm',
            defaultValue: 'events'
          },
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
              import_react12.Link,
              {
                to: 'new',
                className:
                  'flex items-center py-2 px-4 text-sm font-medium text-white bg-blue-600 hover:bg-gray-700 rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 shadow-sm'
              },
                        ...
                        /* @__PURE__ */ React.createElement(
                          ...
                          /* @__PURE__ */ React.createElement(
                            ...
                            /* @__PURE__ */ React.createElement(
                              ...
                              {
                                className:
                                  'flex-1 px-4 min-w-0 md:grid md:grid-cols-2 md:gap-4'
                              },
                              /* @__PURE__ */ React.createElement(
                                'div',
                                null,
                                ...
                                /* @__PURE__ */ React.createElement(
                                  ...
                                  {
                                    className:
                                      'flex items-center mt-2 text-sm text-gray-500'
                                  },
                                  /* @__PURE__ */ React.createElement(
                                    'span',
                                    {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        {
          className:
            'hidden overflow-y-auto p-4 w-96 border-l border-gray-200 lg:block'
        },
...
function EventCard({ content, onDeleteClick, startDate, title }) {
  return /* @__PURE__ */ React.createElement(
    React.Fragment,
    null,
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        import_react13.Link,
        {
          to: 'edit',
          className:
            'py-2 px-4 text-white bg-orange-500 hover:bg-orange-600 focus:bg-orange-400 rounded'
        },
        'Edit'
      ),
      onDeleteClick &&
        /* @__PURE__ */ React.createElement(
          'button',
          {
            ...
            type: 'button',
            className:
              'py-2 px-4 text-white bg-red-500 hover:bg-red-600 focus:bg-red-400 rounded'
          },
          'Delete'
        )
    )
    ...
    /* @__PURE__ */ React3.createElement(
      ...
      /* @__PURE__ */ React3.createElement(
        ...
        /* @__PURE__ */ React3.createElement('textarea', {
          ...
          rows: 4,
          className:
            'flex-1 py-2 px-3 w-full text-lg leading-6 rounded-md border-2 border-blue-500',
          'aria-invalid': (
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          {
            className:
              'flex justify-center items-end p-4 min-h-full text-center sm:items-center sm:p-0'
          },
          /* @__PURE__ */ React.createElement(
            import_react15.Transition.Child,
            {
            ...
            /* @__PURE__ */ React.createElement(
              import_react15.Dialog.Panel,
              {
                className:
                  'overflow-hidden relative text-left bg-white rounded-lg shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg'
              },
              /* @__PURE__ */ React.createElement(
                'div',
                {
                ...
                /* @__PURE__ */ React.createElement(
                  ...
                  icon &&
                    /* @__PURE__ */ React.createElement(
                      ...
                      {
                        className:
                          'flex shrink-0 justify-center items-center mx-auto w-12 h-12 bg-red-100 rounded-full sm:mx-0 sm:mr-4 sm:w-10 sm:h-10'
                      },
                      icon
                    ),
                  /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(
                ...
                {
                  className:
                    'py-3 px-4 bg-gray-50 sm:flex sm:flex-row-reverse sm:px-6'
                },
                /* @__PURE__ */ React.createElement(
                  'button',
                  {
                    ...
                    type: 'submit',
                    className:
                      'inline-flex justify-center py-2 px-4 w-full text-base font-medium text-white bg-red-600 hover:bg-red-700 rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 shadow-sm sm:ml-3 sm:w-auto sm:text-sm',
                    onClick: handleClick
                  },
                  'Delete'
                ),
                /* @__PURE__ */ React.createElement(
                  'button',
                  {
                    type: 'button',
                    className:
                      'inline-flex justify-center py-2 px-4 mt-3 w-full text-base font-medium text-gray-700 bg-white hover:bg-gray-50 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 shadow-sm sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm',
...
function EventDetailsPage() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(DeleteEventDialog, {
      ...
      leftButton: /* @__PURE__ */ React.createElement(
        'button',
        {
          form: 'delete-event',
          type: 'submit',
      ...
      rightButton: /* @__PURE__ */ React.createElement(
        'button',
        {
          form: 'delete-event',
          type: 'submit'
  ...
  return /* @__PURE__ */ import_react20.default.createElement(
    ...
    /* @__PURE__ */ import_react20.default.createElement(
      ...
      /* @__PURE__ */ import_react20.default.createElement(
        ...
        /* @__PURE__ */ import_react20.default.createElement('textarea', {
          ref: contentRef,
          defaultValue:
      ...
      /* @__PURE__ */ React5.createElement(
        ...
        /* @__PURE__ */ React5.createElement(
          ...
          /* @__PURE__ */ React5.createElement('input', {
            ...
            name: 'title',
            className:
              'flex-1 px-3 text-lg leading-loose rounded-md border-2 border-blue-500 focus:border-indigo-500 focus:ring-indigo-500',
            'aria-invalid': (
              (_a = actionData == null ? void 0 : actionData.errors) == null
                ? void 0
                : _a.title
      ...
      /* @__PURE__ */ React5.createElement(
        ...
        /* @__PURE__ */ React5.createElement(
          ...
          /* @__PURE__ */ React5.createElement('textarea', {
            ...
            ref: descriptionRef,
            className:
              'rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm sm:text-sm',
            defaultValue: '',
            'aria-invalid': (
              (_e = actionData == null ? void 0 : actionData.errors) == null
                ? void 0
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      import_react22.Link,
      {
        to: '/timelines/new',
        className:
          'inline-flex items-center py-2 px-4 text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 shadow-sm'
      },
    ...
    data.timelineListItems.length === 0
      ...
      : /* @__PURE__ */ React.createElement(
          ...
          {
            className:
              'grid grid-cols-1 gap-5 mt-3 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4'
          },
            ...
            /* @__PURE__ */ React.createElement(
              ...
              /* @__PURE__ */ React.createElement(
                ...
                /* @__PURE__ */ React.createElement(
                  ...
                  {
                    className:
                      'flex flex-1 justify-between items-center truncate bg-white rounded-r-md border-y border-r border-gray-200'
                  },
                  /* @__PURE__ */ React.createElement(
                    'div',
                    {
...
function useMatchesData(id) {
  ...
  const route = (0, import_react24.useMemo)(
      ...
      /* @__PURE__ */ React6.createElement(
        ...
        /* @__PURE__ */ React6.createElement(
          ...
          /* @__PURE__ */ React6.createElement(
            ...
            /* @__PURE__ */ React6.createElement('input', {
              ...
              'aria-describedby': 'email-error',
              className:
                'py-1 px-2 w-full text-lg rounded border border-gray-500'
            }),
            ((_b = actionData == null ? void 0 : actionData.errors) == null
              ? void 0
              : _b.email) &&
        ...
        /* @__PURE__ */ React6.createElement(
          'button',
          {
            type: 'submit',
            className:
              'py-2 px-4 w-full  text-white bg-blue-500 hover:bg-blue-600 focus:bg-blue-400 rounded'
          },
          'Log in'
        ),
        /* @__PURE__ */ React6.createElement(
...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    {
      className:
        'relative min-h-screen bg-white sm:flex sm:justify-center sm:items-center'
    },
    /* @__PURE__ */ React.createElement(
      'div',
      {
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(
            ...
            {
              className:
                'relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32 lg:pb-20'
            },
            /* @__PURE__ */ React.createElement(
              'h1',
              {
                className:
                  'text-6xl font-extrabold tracking-tight text-center sm:text-8xl lg:text-9xl'
              },
              /* @__PURE__ */ React.createElement(
                'span',
                {
            ...
            /* @__PURE__ */ React.createElement(
              ...
              {
                className:
                  'mx-auto mt-6 max-w-lg text-xl text-center text-white sm:max-w-3xl'
              },
            ...
            /* @__PURE__ */ React.createElement(
              ...
              {
                className:
                  'mx-auto mt-10 max-w-sm sm:flex sm:justify-center sm:max-w-none'
              },
              user
                ? /* @__PURE__ */ React.createElement(
                    import_react28.Link,
                    {
                      to: '/timelines',
                      className:
                        'flex justify-center items-center py-3 px-4 text-base font-medium text-yellow-700 bg-white hover:bg-yellow-50 rounded-md border border-transparent shadow-sm sm:px-8'
                    },
                    'View Timelines for ',
                    user.email
                  )
                : /* @__PURE__ */ React.createElement(
                    ...
                    {
                      className:
                        'space-y-4 sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:mx-auto sm:space-y-0'
                    },
                    /* @__PURE__ */ React.createElement(
                      import_react28.Link,
                      {
                    ...
                    /* @__PURE__ */ React.createElement(
                      import_react28.Link,
                      {
                        to: '/login',
                        className:
                          'flex justify-center items-center py-3 px-4 font-medium text-white bg-yellow-500 hover:bg-yellow-600 rounded-md  '
                      },
                      'Log In'
                    )
                  )
...
var assets_manifest_default = {
  ...
  routes: {
    ...
    'routes/__auth/logout': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/__auth/logout-IDL4DQS7.js',
      imports: void 0,
      hasAction: true,
      hasLoader: true,
      hasCatchBoundary: false,
    ...
    'routes/healthcheck': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/healthcheck-UW4G2OK6.js',
      imports: void 0,
      hasAction: false,
      hasLoader: true,
      hasCatchBoundary: false,
    ...
    'routes/timeline/$timelineId/events/index': {
      ...
      index: true,
      caseSensitive: void 0,
      module: '/build/routes/timeline/$timelineId/events/index-7N6A5OI4.js',
      imports: void 0,
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
    ...
    'routes/timeline/$timelineId/people': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/timeline/$timelineId/people-YKHY24TX.js',
      imports: void 0,
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
    ...
    'routes/timeline/$timelineId/places': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/timeline/$timelineId/places-54GJYJXW.js',
      imports: void 0,
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
