...
INSERT INTO "new_event" ("content", "createdAt", "id", "locationId", "startDate", "timelineId", "title", "updatedAt") SELECT "content", "createdAt", "id", "locationId", "startDate", "timelineId", "title", "updatedAt" FROM "event";
DROP TABLE "event";
